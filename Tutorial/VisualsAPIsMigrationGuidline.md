...
To migrate from the legacy APIs to the new versioned Visuals API, use [PowerBI visuals CLI tools](https://github.com/Microsoft/PowerBI-visuals#setting-up-environment) and [NPM API packages](/Microsoft/PowerBI-visuals/blob/master/Tutorial/MigrationGuidlineAPI.1.3.md#npmpackages). 
